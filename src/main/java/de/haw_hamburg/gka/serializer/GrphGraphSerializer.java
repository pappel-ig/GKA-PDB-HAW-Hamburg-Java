    ...
    private static class GrphFileParser {
        ...
        private void parseHeader() {
            ...
            if (matcher.find()) {
                ...
                // read graph name
                graph.setName(matcher.group("name"));
        ...
        private void parseNodesAndEdges() {
            ...
            while (scanner.hasNext()) {
                ...
                if (matcher.find()) {
                    ...
                    line.setNode1(matcher.group("node1"));
                    line.setAttr1(matcher.group("attr1"));
                    line.setNode2(matcher.group("node2"));
                    line.setAttr2(matcher.group("attr2"));
                    line.setEdge(matcher.group("edge"));
